...
void time_for_merge(int x, int a) {
  ...
  for (int i = 0; i < 10; i++) {
    ...
    if (!fin.is_open()) {
      ...
      cout << "Time elapsed (ns) for merge " + string1 + "(" + s + ").txt" + ": " << time_elapsed_ns << '\n';
    }
    fin.close();
  }
}
...
void time_for_insert(int x, int a) {
  ...
  for (int i = 0; i < 10; i++) {
    ...
    if (!fin.is_open()) {
      ...
      cout << "Time elapsed (ns) for insert " + string1 + "(" + s + ").txt" + ": " << time_elapsed_ns << '\n';
    }
    fin.close();
  }
}
...
void time_for_find(int x, int a) {
  ...
  for (int i = 0; i < 10; i++) {
    ...
    if (!fin.is_open()) {
      ...
      cout << "Time elapsed (ns) for " + string1 + "(" + s + ").txt" + ": " << time_elapsed_ns << '\n';
    }
    fin.close();
  }
}
